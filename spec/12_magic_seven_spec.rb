...
describe MagicSeven do
  ...
  describe '#divide_by_two' do
    context 'when the previous step is 14'
      it 'returns 7' do
        previous_step = 14
  ...
  describe '#subtract_random_number' do
    context 'when the initial random number is 11'
      it 'returns 9' do
        random_number = 11
        test_game = described_class.new(random_number)
        result = test_game.subtract_random_number(20)
